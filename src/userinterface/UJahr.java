...
// METHODEN ***************************************************************
	...
	private void setGridContent() {
		/*
		String Jahr = "";
		float JahrGesamtPreis = 0;				
		String JahrGesamtPreisString = "";
		...
		for (int i = 0; i < KundenListe1.size(); i++) {
			...
			Jahr = getYear();
			JahrGesamtPreis = getPriceOfYear(Jahr);						
			JahrGesamtPreisString = String.valueOf(JahrGesamtPreis); 
			JahrGesamtPreisString = String.format("%.2f",JahrGesamtPreis + " €");
			
			

			rowList[0] = Jahr;
			rowList[1] = JahrGesamtPreisString;
	...
	private float getPriceOfYear(String Year) {
		float Price =0;
